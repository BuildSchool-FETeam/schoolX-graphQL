...
export class InitApp1614055475867 implements MigrationInterface {
    name = 'InitApp1614055475867'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "admin_user" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, "role" character varying, CONSTRAINT "REL_faa5e69338cb413df6d4e4926b" UNIQUE ("role"), CONSTRAINT "PK_a28028ba709cd7e5053a86857b4" PRIMARY KEY ("id"))`);
        await queryRunner.query(`ALTER TABLE "role" ADD CONSTRAINT "FK_af366ff26484d6faf9c15349f42" FOREIGN KEY ("permissionSetId") REFERENCES "permission_set"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
