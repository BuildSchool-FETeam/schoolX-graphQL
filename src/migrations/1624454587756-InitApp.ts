...
export class InitApp1624454587756 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "article" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "shortDescription" character varying NOT NULL, "content" character varying NOT NULL, "votes" integer DEFAULT '0', "status" character varying DEFAULT 'pending', "views" integer DEFAULT '0', "shares" integer DEFAULT '0', "reviewComment" character varying, "createdById" uuid, CONSTRAINT "PK_40808690eb7b915046558c0f81b" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "user_comment" ADD "replyToId" integer`);
        ...
        await queryRunner.query(`ALTER TABLE "article" ADD "reviewComment" character varying`);
        ...
        await queryRunner.query(`ALTER TABLE "user_comment" ALTER COLUMN "votes" SET DEFAULT '0'`);
        ...
        await queryRunner.query(`ALTER TABLE "user_comment" ADD CONSTRAINT "FK_a1e7c2470588154415ce0b1d9fe" FOREIGN KEY ("createdById") REFERENCES "client_user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "user_comment" ADD CONSTRAINT "FK_2ae796e94ef5d41e414d036397f" FOREIGN KEY ("replyToId") REFERENCES "user_comment"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user_comment" DROP CONSTRAINT "FK_2ae796e94ef5d41e414d036397f"`);
        await queryRunner.query(`ALTER TABLE "user_comment" DROP CONSTRAINT "FK_0f3902d2d0144f517fb46cbdd9f"`);
        await queryRunner.query(`ALTER TABLE "user_comment" DROP CONSTRAINT "FK_a1e7c2470588154415ce0b1d9fe"`);
        ...
        await queryRunner.query(`ALTER TABLE "user_comment" ALTER COLUMN "votes" DROP DEFAULT`);
        await queryRunner.query(`COMMENT ON COLUMN "user_comment"."votes" IS NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "article" DROP COLUMN "status"`);
        await queryRunner.query(`ALTER TABLE "article" DROP COLUMN "content"`);
        await queryRunner.query(`ALTER TABLE "user_comment" DROP COLUMN "replyToId"`);
        await queryRunner.query(`ALTER TABLE "user_comment" DROP COLUMN "createdById"`);
        await queryRunner.query(`ALTER TABLE "article" ADD "createdById" uuid`);
        await queryRunner.query(`ALTER TABLE "article" ADD "reviewComment" character varying`);
        await queryRunner.query(`ALTER TABLE "article" ADD "shares" integer DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "article" ADD "views" integer DEFAULT '0'`);
