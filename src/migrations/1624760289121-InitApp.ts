...
export class InitApp1624760289121 implements MigrationInterface {
  name = 'InitApp1624760289121';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "test_case" ADD "timeEvaluation" integer`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "test_case" DROP COLUMN "timeEvaluation"`,
    );
    await queryRunner.query(`ALTER TABLE "article" ADD "createdById" uuid`);
    await queryRunner.query(
      `ALTER TABLE "article" ADD "reviewComment" character varying`,
