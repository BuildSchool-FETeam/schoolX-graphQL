...
export class InitApp1624071718991 implements MigrationInterface {
    name = 'InitApp1624071718991'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "article" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "shortDescription" character varying NOT NULL, "content" character varying NOT NULL, "votes" integer DEFAULT '0', "status" character varying DEFAULT 'pending', "views" integer DEFAULT '0', "shares" integer DEFAULT '0', "createdById" uuid, CONSTRAINT "PK_40808690eb7b915046558c0f81b" PRIMARY KEY ("id"))`);
